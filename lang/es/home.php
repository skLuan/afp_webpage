...
Más resistente, dúctil y sin necesidad de mantenimiento.',
    ...
    'infoService' => 'Nuestro compromiso es ofrecer un servicio excepcional en la vanguardia de nuestras operaciones:',
    'Service1' => 'Ponemos un fuerte énfasis en proporcionar una atención al cliente de alta calidad, construyendo la confianza del cliente y una reputación positiva.',
    'Service2' => 'Para mantenernos a la vanguardia de la industria, adoptamos tecnologías avanzadas y procesos eficientes para garantizar un servicio rápido y preciso.',
    'Service3' => 'La colaboración con clientes, proveedores y socios del mercado es clave para ofrecer soluciones innovadoras y mejoras continuas en el servicio.',
    'Service4' => 'Monitorizamos continuamente el rendimiento y la calidad de nuestros diseños para identificar áreas de mejora y mantenernos por delante de la competencia.',
    'infoFiberIg' => 'Estamos comprometidos a proporcionar a nuestros clientes el mejor servicio y productos posibles, ofreciendo una amplia gama de fibras de alta calidad, con diferentes tipos y especificaciones para satisfacer las necesidades únicas de cada cliente.',
