    <div class="grid grid-cols-2 gap-5">
        ...
        <div>
            <div class="flex relative !appearance-none">
                <label class="my-auto" for="brand">Brand/model</label>
                <input class="!appearance-none ml-auto w-52" type="text" placeholder="" name="brand"
                    id="brand">
            </div>
            <div class="flex relative !appearance-none">
                <label class="my-auto" for="staticWheel">Maximum <b>Static</b> Wheel Load</label>
            ...
            <div id="tirePressure" class="flex flex-row justify-between mb-5">
                <label class="my-auto" for="tirePressure">Tire (inflation) pressure</label>
                <select class="w-52" name="tirePressure" id="tirePressure">
                    <option value="Trilateral">Trilateral</option>
                    <option value="Montacargas">Montacargas</option>
                    <option value="V. liviano">V. liviano</option>
                </select>
            </div>
            <div id="" class="flex flex-row justify-between mb-5">
                <label for="wheelConfig">Wheel Configuration</label>
            ...
            <div class="flex relative !appearance-none">
                <label class="my-auto" for="wheelDistance">Wheel Distance Sd =</label>
            ...
            <div class="flex relative !appearance-none">
                <label class="my-auto" for="wheelBase">Wheelbase sa =</label>
                <input class="!appearance-none ml-auto w-52" type="number" placeholder="" name="wheelBase"
                    id="wheelBase">
                <span class="absolute right-0 pr-9 translate-y-[30%]">mm</span>
            </div>
            <div id="tireMaterial" class="flex flex-row justify-between mb-5">
                <label class="my-auto" for="tireMaterial">Wheel type</label>
