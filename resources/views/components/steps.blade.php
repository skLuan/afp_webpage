...
<div class="swiperSteps">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div class="how-work-divvv grid gap-[15px] grid-cols-5 lg:grid-cols-12">
                <picture class="col-span-3 lg:col-span-7 mt-auto mb-2">
                ...
                <div class="col-start-4 col-span-2 lg:col-start-8 lg:col-span-4 mt-8 mb-auto pr-5">
                    <picture class="">
                        <img class="mx-auto" src="{{ Vite::asset('resources/img/circle-img-space.png') }}"
                            alt="">
                    </picture>
        ...
        {{-- -------------------------cut of divs 2 --}}
        <div class="swiper-slide">
            <div class="how-work-divvv hidden gap-[15px] grid-cols-5 lg:grid-cols-12">
                <div class="col-span-2 lg:col-span-4 lg:col-start-2 mt-8 mb-auto pl-5">
                    <picture class="">
                        <img class="mx-auto" src="{{ Vite::asset('resources/img/circle-img-space.png') }}"
                            alt="">
                    </picture>
                ...
                <picture class="col-span-3 lg:col-start-6 lg:col-span-7 mt-auto mb-2">
                    <source media="(min-width: 1000px)" srcset="{{ Vite::asset('resources/img/how-work-img-pc.png') }}">
                    <img width="100%" src="{{ Vite::asset('resources/img/how-work-img.png') }}" alt="">
                </picture>
                {{-- -------------------------------------- Text mobile --}}
        ...
        <div class="swiper-slide">
            <div class="how-work-divvv hidden gap-[15px] grid-cols-5 lg:grid-cols-12">
                ...
                <div class="col-start-4 col-span-2 lg:col-start-8 lg:col-span-4 mt-8 mb-auto">
                    <picture class="">
                        <img class="mx-auto" src="{{ Vite::asset('resources/img/circle-img-space.png') }}"
                            alt="">
                    </picture>
