<div id="tabs-work" class="swiper-pagination !relative bg-grey flex flex-row justify-evenly py-2 shadow-afp top-0 bottom-0">
</div>
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div class="how-work-div grid grid-cols-5 lg:grid-cols-12 bg-yellow-dark">
                ...
                {{-- --------------Information --}}
                <div class="col-start-4 col-span-2 lg:col-start-8 lg:col-span-5 mt-8 mb-auto lg:my-auto lg:mx-auto lg:w-5/6 pr-5 lg:pr-0">
                    <picture class="">
